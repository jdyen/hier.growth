...
#include "stanExports_spline_pred_blockmod.h"

RCPP_MODULE(stan_fit4spline_pred_blockmod_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_spline_pred_blockmod")
