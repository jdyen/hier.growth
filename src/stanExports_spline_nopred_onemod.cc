...
#include "stanExports_spline_nopred_onemod.h"

RCPP_MODULE(stan_fit4spline_nopred_onemod_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_spline_nopred_onemod")
