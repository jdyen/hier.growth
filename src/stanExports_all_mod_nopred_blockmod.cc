...
#include "stanExports_all_mod_nopred_blockmod.h"

RCPP_MODULE(stan_fit4all_mod_nopred_blockmod_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_all_mod_nopred_blockmod")
